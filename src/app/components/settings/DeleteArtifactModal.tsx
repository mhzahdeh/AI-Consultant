...
export function DeleteArtifactModal({ isOpen, onClose, artifactName, artifactType }: DeleteArtifactModalProps) {
        ...
        <>
          ...
          >
            ...
            <div className="mb-6 border border-black/10 bg-white p-4">
              <div className="mb-2 text-xs text-black/60">Artifact to be deleted:</div>
              <div className="mb-1 text-sm text-black">{artifactName}</div>
              <div className="text-xs text-black/60">Type: {artifactType}</div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="mb-2 text-xs text-black/70">
                    Deleting this artifact will:
                  </div>
                  <div className="space-y-1 text-xs text-black/70">
                    <div>• Remove the artifact from your engagement workspace</div>
                    <div>• Delete all version history for this artifact</div>
                    <div>• Remove it from search and vault results</div>
                    <div>• Make it unavailable for export or reuse</div>
                    <div>• Not affect the engagement itself or other artifacts</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 text-xs text-black/60">
              The artifact will be removed from the application immediately. Underlying storage cleanup follows a 30-day retention window, after which all versions are permanently deleted.
            </div>
